...
<body>
  ...
  <nav class="landing-nav" role="navigation" aria-label="Navegación principal">
    <div class="landing-nav-inner">
      ...
      <div class="landing-nav-actions">
        <a href="nosotros.html" class="btn btn-ghost btn-sm">Nosotros</a>
        <a href="login.html" id="nav-btn" class="btn btn-ghost btn-sm">Ingresar</a>
        <a href="catalogo.html" class="btn btn-naranja btn-sm">
          Ver productos →
        </a>
      </div>
    </div>
  ...
  <section class="hero-landing" aria-label="Bienvenida">
    <div class="hero-content">
      <div class="hero-texto">
        ...
        <div class="hero-btns">
          <a href="catalogo.html" class="btn-hero-primary">
            🛍️ Ver productos
          </a>
          <a href="login.html?tab=registro" class="btn-hero-secondary">
  ...
  <section class="cta-sec" aria-label="Llamada a la acción">
    ...
    <a href="login.html" class="btn-hero-primary" style="display:inline-flex">
      Registrar mi panadería →
    </a>
  </section>

  <footer style="text-align:center;padding:24px;font-size:0.8rem;color:var(--gris);background:var(--blanco)">
    <a href="terminos.html" style="color:var(--gris)">Términos y Condiciones</a> ·
    <a href="privacidad.html" style="color:var(--gris)">Privacidad</a> ·
    <a href="nosotros.html" style="color:var(--gris)">Sobre nosotros</a>
  </footer>
