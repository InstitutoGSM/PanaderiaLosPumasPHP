...
<body>
  ...
  <div class="terms-wrap">
    ...
    <div class="terms-sec">
      ...
      <ul>
        <li><strong>Cuenta:</strong> nombre completo, email y contraseña (almacenada con hash seguro).</li>
    ...
    <div class="terms-sec">
      ...
      <p>Los datos se almacenan en una base de datos <strong>MySQL</strong> alojada en el servidor propio del proyecto, con cifrado en tránsito (HTTPS). Las imágenes (productos, avatares) se almacenan en la carpeta <code>uploads/</code> del servidor.</p>
    </div>
